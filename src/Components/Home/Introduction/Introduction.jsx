...
const Introduction = () => {
  ...
  return (
    <div className="text-white flex flex-col justify-center ">
      <div className="lg:flex md:flex lg:flex-row-reverse md:flex-row-reverse justify-between lg:justify-between items-center">
        {/* <div className="pt-28 md:pt-0 lg:pt-0"> */}
          <figure className="h-120 flex-1 w-full mb-7 md:mb-0 lg:mb-0 ">
            <img src={profile} className="h-full w-full object-cover -ml-6 md:ml-0 lg:ml-0" alt="" />
          </figure>
        ...
        <div className="flex-1 flex flex-col">
          <h6 className="text-3xl lg:text-5xl md:text-5xl">
            <p className="text-xl">Hello, I'm</p>
            <span className="text-2xl lg:text-3xl md:text-2xl text-[#f1f5f9] font-semibold">Chadnee Akhter</span>
          </h6>
          {isMediumOrLargeDevice && (
            <h3 className="text-2xl lg:text-3xl md:text-2xl pt-1   ">
          ...
          <span
            className="font-light text-[#ecf1f6] text-sm lg:text-[16px] md:text-[16px] tracking-wider pt-6 line-clamp-4 lg:line-clamp-none"
          >
            A spontaneous developer in creating visually stunning, highly
            functional & innovative responsive website using modern technologies
            ensuring efficient user experiences with clean architecture, optimized performance, and scalable solutions .
          </span>

          <div className="flex justify-start gap-5 lg:mt-12 mt-8 md:my-8 lg:my-8">
            <Button
              to="/resume"
              text="Resume"
              target="_blank"
            ...
            <div className="flex gap-5 text-center">
             <a href="https://www.facebook.com/chadnee.akhter.73?mibextid=ZbWKwL">
                {/* 2e5c59 */}
                {/* border-2 border-[#222b43]*/}
                <button
                  className="rounded-lg text-3xl md:p-2 lg:p-4 text-[#f1f5f9] shadow-[0_0_2px_2px_#222b43] hover:shadow-none  hover:bg-[#1b253d] hover:text-white"
                >
                  <FaFacebook></FaFacebook>
                </button>
              </a>
              <button
                className="rounded-lg text-3xl md:p-2 lg:p-4 text-[#f1f5f9] shadow-[0_0_2px_2px_#222b43] hover:shadow-none  hover:bg-[#222b43] hover:text-white"
              >
                <FaGithub></FaGithub>
              </button>
              <button
          ...
          {/* <button
            className="py-1 px-5 mt-4 bg-[#222b43]"
            style={{ boxShadow: "0 0 4px 4px #263153" }}
          >
            Hire me
          </button> */}
        </div>
...
//                 <span style={{ letterSpacing: "1px" }} className='text-sm  font-light lg:w-[500px] md:w-[500px] block pt-2'>A spontaneous developer in creating visually stunning, highly functional & innovative responsive website using modern technologies
